...
export const Footer = () => {
  return (
    <div className="max-w-screen-xl mx-auto flex justify-between items-center h-[30px] p-4 md:p-8 fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300">
